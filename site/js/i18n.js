...
export const STRINGS = {
  en: {
    title: "Bearing Health Monitor — predict bearing failure weeks ahead",
    hero_h1: "Predict bearing failure weeks ahead",
    ...
    p1_p: "On NASA run-to-failure data the detector names the failing bearing element and raises the alarm about 2.5 days before the bearing dies.",
  ...
  ru: {
    title: "Bearing Health Monitor — предсказание отказа подшипника за недели",
    hero_h1: "Предсказывайте отказ подшипника за недели до поломки",
    ...
    p1_p: "На данных NASA с испытаний до разрушения детектор называет повреждённый элемент подшипника и поднимает тревогу примерно за 2,5 суток до отказа.",
  ...
  kk: {
    title: "Bearing Health Monitor — мойынтірек ақауын апталар бұрын болжау",
    hero_h1: "Мойынтіректің істен шығуын апталар бұрын болжаңыз",
    ...
    p1_p: "NASA-ның бұзылғанға дейінгі сынақ деректерінде детектор мойынтіректің зақымдалған элементін дәл атап, істен шығудан шамамен 2,5 тәулік бұрын дабыл береді.",
